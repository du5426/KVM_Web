...
$(document).ready(function() {
     ...
     */
    $(document).on('click','#hidden-table-info1 tbody td img',function () {
    ...
    nCloneTd2.innerHTML = '<img src="images/details_open.png">';
     ...
     * Initialse DataTables, with no sorting on the 'details' column
     */
    var oTable2 = $('#hidden-table-info2').dataTable( {
        "aoColumnDefs": [
            { "bSortable": false, "aTargets": [ 0 ] }
        ],
        "aaSorting": [[1, 'asc']]
    ...
    $(document).on('click','#hidden-table-info2 tbody td img',function () {
        ...
        else
        {
            /* Open this row */
            this.src = "images/details_close.png";
            oTable2.fnOpen( nTr, fnFormatDetails(oTable, nTr), 'details' );
        }
    } );
